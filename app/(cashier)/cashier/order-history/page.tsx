    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
        <div>
          ...
          <p style={{ color: "#a89080", fontSize: "13px", marginTop: "4px" }}>Completed and cancelled orders</p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "16px", marginBottom: "24px" }}>
        {[
          { label: "Total Completed", value: completedCount, icon: "✅", color: "#22c55e" },
          { label: "Total Cancelled", value: cancelledCount, icon: "❌", color: "#ef4444" },
          { label: "Revenue (Completed)", value: peso(totalRevenue), icon: "💰", color: ACCENT },
        ].map((s) => (
      ...
      <div style={{ display: "flex", gap: "12px", marginBottom: "20px", alignItems: "center" }}>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: "8px", background: "#fff", borderRadius: "8px", padding: "8px 12px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", maxWidth: "280px" }}>
            ...
            <div key={o.id} style={{ background: "#fff", borderRadius: "12px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", overflow: "hidden" }}>
              ...
              {isExpanded && (
                <div style={{ borderTop: "1px solid #f1ebe5", padding: "14px 18px", background: "#faf7f4" }}>
                  <div style={{ fontSize: "11px", fontWeight: 700, color: "#a89080", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "10px" }}>Items</div>
                  ...
                  {o.notes && <div style={{ marginTop: "10px", fontSize: "12px", color: "#92400e", background: "#fffbeb", border: "1px solid #fde68a", borderRadius: "6px", padding: "8px 10px" }}>Note: {o.notes}</div>}
                  <div style={{ marginTop: "12px", paddingTop: "10px", borderTop: "1px solid #ede8e3", display: "flex", justifyContent: "space-between", fontWeight: 800, fontSize: "14px" }}>
